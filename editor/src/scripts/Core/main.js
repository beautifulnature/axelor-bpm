...
ORYX.Editor = {
	...
	_generateHeader: function(){
		...
		var headerPanel = new Ext.Panel({
			...
			autoHeight	: false,
			border		: false,
			html		: "<div id='oryx_editor_header'><a href=\"http://axelor.com\"><img src='"+ORYX.PATH+"images/oryx.small.gif' border=\"0\" /></a><div style='clear: both;'></div></div>" 
		});
		...
		var fn = function(val){
			...
			var content = 	"<div id='oryx_editor_header'>" +
								"<a href=\"http://axelor.com\"><img src='"+ORYX.PATH+"images/oryx.small.gif' border=\"0\" />" + 
								"</a>" + 
