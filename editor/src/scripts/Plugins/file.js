...
ORYX.Plugins.Save = Clazz.extend({
    ...
    saveSynchronously: function(forceNew, modelInfo){
		...
		callback = function(){
				...
				modelMeta.name = "testing";
				modelMeta.description = "testing";
				modelMeta.parent = modelInfo.parent;
				modelMeta.namespace = "testing";
		        ...
		        var params = {
					...
					name:modelMeta.name,
		        		axelorPath: modelMeta.axelorPath,
		        		sessionId: modelMeta.sessionId,
				...
				if(modelMeta["new"]) {	
					...
					Ext.Msg.alert(ORYX.I18N.Oryx.title, "force New").setIcon(Ext.Msg.WARNING).getDialog().setWidth(260).center().syncSize();			
					this.sendSaveRequest('POST', reqURI, params, forceNew, successFn, failure);
				} else {
