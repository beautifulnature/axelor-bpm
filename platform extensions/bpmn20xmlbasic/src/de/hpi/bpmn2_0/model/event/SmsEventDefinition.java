...
@XmlType(name = "tSmsEventDefinition", propOrder = {
    "operationRef",
    "messageRef",
    "template",
    "templateRule",
...
public class SmsEventDefinition
    extends EventDefinition
{
    ...
    /* Constructors */
    public SmsEventDefinition() {
    	super();
    }
    
    public SmsEventDefinition(SmsEventDefinition msgEvDef) {
