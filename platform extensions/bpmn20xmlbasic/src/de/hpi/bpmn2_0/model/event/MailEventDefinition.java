...
@XmlType(name = "tMailEventDefinition", propOrder = {
    "operationRef",
    "messageRef",
    "template",
    "templateRule",
...
public class MailEventDefinition
    extends EventDefinition
{
    ...
    /* Constructors */
    public MailEventDefinition() {
    	super();
    }
    
    public MailEventDefinition(MailEventDefinition msgEvDef) {
