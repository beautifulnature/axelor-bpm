...
@XmlType(name = "tPhoneCallEventDefinition", propOrder = {
    "operationRef",
    "messageRef",
    "template",
    "templateRule",
...
public class PhoneCallEventDefinition
    extends EventDefinition
{
    ...
    /* Constructors */
    public PhoneCallEventDefinition() {
    	super();
    }
    
    public PhoneCallEventDefinition(PhoneCallEventDefinition msgEvDef) {
