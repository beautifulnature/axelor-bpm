...
@XmlType(name = "tInternetSiteEventDefinition", propOrder = {
    "operationRef",
    "messageRef",
    "template",
    "templateRule",
...
public class InternetSiteEventDefinition
    extends EventDefinition
{
    ...
    /* Constructors */
    public InternetSiteEventDefinition() {
    	super();
    }
    
    public InternetSiteEventDefinition(InternetSiteEventDefinition msgEvDef) {
