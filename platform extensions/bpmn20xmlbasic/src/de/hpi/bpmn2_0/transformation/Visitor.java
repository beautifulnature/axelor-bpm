...
public interface Visitor {
	...
	public void visitTemplateRule(TemplateRule that);

	public void visitTemplate(Template that);
	
	public void visitMailAccount(Account that);
	
	public void visitFilter(Filter that);
	
	public void visitSocialNetworkEvent(SocialNetworkEvent that);
}
