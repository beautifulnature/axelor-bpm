...
//		}
	...
	public FsModel createModel(String name, String description, String type, String jsonRep, String svgRep, String comment, String axelorPath, String sessionId) {
		return createModel(UUID.getUUID().toString(), name, description, type, jsonRep, svgRep, comment, axelorPath, sessionId);
	}

	public FsModel createModel(String id, String name, String description, String type, String jsonRep, String svgRep, String comment, String axelorPath, String sessionId) {
		name = FileSystemUtil.getCleanFileName(name);
...
//		String path = getPath() + File.separator + name + modelType.getFileExtension();
		...
		modelType.storeModel(path, id, namespace, description, type, jsonRep, svgRep, axelorPath, sessionId);
