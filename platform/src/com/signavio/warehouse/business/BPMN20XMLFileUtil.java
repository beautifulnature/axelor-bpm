...
public class BPMN20XMLFileUtil {
	...
	public static void storeBPMN20XMLFile(String axelorPath, String jsonRep, String sessionId, String path) throws IOException, JSONException, BpmnConverterException, JAXBException, SAXException, ParserConfigurationException, TransformerException {
		...
		StringWriter xmlString = converter.getXml();
		FileSystemUtil.saveXml(path, xmlString.toString(), axelorPath, sessionId, true);
	}
}
